                    ...
                    <div className="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
                        ...
                        <div className="col-xs-12 col-xl-6 order-2 order-xl-1">
                            <ul className="nav justify-content-center">
                                <li className="nav-item">
                                    <a className="nav-link link-secondary px-2 px-md-3" href="javascript:void(0)">About</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link link-secondary px-2 px-md-3" href="javascript:void(0)">Contact</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link link-secondary px-2 px-md-3" href="javascript:void(0)">Advertise</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link link-secondary px-2 px-md-3" href="javascript:void(0)">Terms</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link link-secondary px-2 px-md-3"href="javascript:void(0)">Privacy</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="col-xs-12 col-sm-6 col-xl-3 order-1 order-xl-2">
                            <ul className="nav justify-content-center justify-content-sm-end">
                                <li className="nav-item">
                                    <a className="nav-link link-dark px-3" href="javascript:void(0)">
                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            <div className="credits text-secondary text-center mt-2 fs-7">
                                Built by <a href="https://bootstrapbrain.com/" className="link-secondary text-decoration-none">Rahul</a> with <span className="text-primary">&#9829;</span>
                            </div>
                        </div>
                    </div>
                </div>
