...
const Input = (props: any) => {
    const { type, error, errormessage, label, onChange, value, required, isPassword, showPassword, setShowPassword, register, placeholder, isTextArea, disabled,style} = props;
